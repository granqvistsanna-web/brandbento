...
2. Add CSS to App.css:
  ...
  <done>
    Integration test harness created with all tiles and edit panels
  </done>
</task>
...
6. Toggle background (White, Dark, Brand) - tile background changes
7. Close panel (X button)

**Typography Tile Tests:**
8. Click primary font tile - edit panel opens
9. Type "Montserrat" in search - font list filters
10. Hover over "Montserrat" - font preview appears in tile immediately
11. Click "Montserrat" - font commits, tile updates
12. Adjust weight slider - weight changes (notice dot indicator)
13. Adjust size slider - text size changes
14. Adjust line height slider - spacing changes
15. Close panel

16. Click secondary font tile - separate edit panel
17. Select a serif font (e.g., "Merriweather")
18. Verify it updates body text tile

**Undo/Redo Tests:**
19. Note undo count in header
20. Make 3 changes (font, weight, size)
21. Verify undo count is 3
22. Click Undo 3 times - changes revert in order
23. Click Redo - changes reapply
24. Drag slider slowly through multiple values
25. Release slider
26. Click Undo once - should revert to pre-drag value (single step)

**Font Picker Tests:**
27. Open font picker, verify popular fonts shown first
28. Click category filters - list filters correctly
29. Scroll font list - should be smooth (virtualized)
30. Select a font - verify it appears in "Recent" section next time
  </how-to-verify>
