...
must_haves:
  truths:
    ...
    - "Fonts load on-demand from Google Fonts API"
    - "System fallback shown on load failure"
  artifacts:
...
6. TYPE-14: Fonts load on-demand via Google Fonts CSS API v2
7. TYPE-15: System fallback shown when font not yet loaded
</verification>
