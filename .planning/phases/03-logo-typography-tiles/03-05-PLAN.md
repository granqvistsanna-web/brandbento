...
must_haves:
  ...
  artifacts:
    - path: "src/components/panels/FontEditPanel.tsx"
      ...
      min_lines: 120
    - path: "src/components/TypographyTileWithPanel.tsx"
      provides: "Container wiring tile preview to FontEditPanel"
      min_lines: 30
  key_links:
    ...
    - from: "src/components/TypographyTileWithPanel.tsx"
      to: "src/components/panels/FontEditPanel.tsx"
      via: "FontEditPanel import with onPreviewChange"
      pattern: "FontEditPanel"
---
