...
autonomous: true
superseded_context: |
  Plan 06-01 was superseded. No Toolbar.tsx exists. Wire export functionality
  to existing UI (header buttons in App.tsx or ControlPanel). Install html-to-image
  as first task. Keyboard shortcuts already exist in ControlPanel.jsx.
