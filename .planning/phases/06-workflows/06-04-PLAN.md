...
autonomous: true
superseded_context: |
  Plan 06-01 was superseded. No Toolbar.tsx or useKeyboardShortcuts hook exists.
  Keyboard shortcuts are in ControlPanel.jsx. The main canvas is BentoCanvasNew.jsx
  (not BentoCanvas.jsx). Adapt examples accordingly.
